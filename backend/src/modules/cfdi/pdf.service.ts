...
import {
  drawTimbreFiscal, drawPageNumbers, extractNoCertificado, montoEnLetra,
...
/* numeroALetras y palabraMoneda vivían aquí duplicadas de pdf-helpers.
 * Se borraron: la copia de aquí se corrigió para las facturas y la otra
 * se quedó diciendo "M.N." en euros para notas de crédito y complementos
 * de pago. Ahora hay una sola, en pdf-helpers, que usan los tres. */
